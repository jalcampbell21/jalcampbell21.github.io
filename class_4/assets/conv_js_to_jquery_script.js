$(document).ready(function(){ //Initalizing jQuery

	//Get usernames for users to sign in
	$validUsernames = function
		{"user": "Username"},
		{"user": "SarahH"},
		{"user": "Charlie"},
		{"user": "Smith"},
...
//Create emails and passwords that users can log in with

var validEmails = [
	{"user": "user_1@gmail.com"},
	{"user": "user_2@gmail.com"},
	{"user": "user_3@gmail.com"},
];
